...
import { Box, ArrowRight, ShieldCheck, Mail, Lock, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start your journey to digital excellence today.</p>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/5 text-center">
          <p className="text-gray-400 text-sm">
            Already have an account? <Link to="/login" className="text-neon-purple font-bold hover:underline">Log in</Link>
          </p>
        </div>
